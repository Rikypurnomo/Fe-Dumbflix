    ...
    <>
      <Container className="">
        <>
          ...
          <div className="d-flex justify-content-sm-start justify-content-center mt-4" id="wrap">
            {filteredFilms?.map((item) => {
              return (
                <>
                  <NavLink to={state.isLogin ? `/detail/${item.id}` : '#'} onClick={!state.isLogin ? handleShowLogin : null} className="text-decoration-none d-flex" key={item.id}>
